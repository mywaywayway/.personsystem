...
public class Generator {
    // 数据库连接字段配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/perinfosystem?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSl=true";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSWORD = "541800";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.example.demo";

    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"user","output","income","memorandum","communication","workplane"};
